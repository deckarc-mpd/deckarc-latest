...
const ganesh: RepresentativeProject = {
  ...
  crewConfirmations: [
    { id: 'ganesh-c1', project_id: 'proj-ganesh', task_id: 'ganesh-t2', scheduled_date: TOMORROW, confirmation_status: 'Confirmed', crew_available: true, start_time_confirmed: true, site_access_confirmed: true },
  ],
  materials: [
...
const miller: RepresentativeProject = {
  ...
  crewConfirmations: [
    { id: 'miller-c1', project_id: 'proj-miller', task_id: 'miller-t2', scheduled_date: TOMORROW, confirmation_status: 'Confirmed', crew_available: true, start_time_confirmed: true, site_access_confirmed: true },
  ],
  materials: [
...
const thompson: RepresentativeProject = {
  ...
  crewConfirmations: [
    { id: 'thompson-c1', project_id: 'proj-thompson', task_id: 'thompson-t1', scheduled_date: TOMORROW, confirmation_status: 'Need Reschedule', crew_available: false, start_time_confirmed: false, site_access_confirmed: true },
  ],
  materials: [],
  dailyUpdates: [
...
const patel: RepresentativeProject = {
  ...
  crewConfirmations: [
    { id: 'patel-c1', project_id: 'proj-patel', task_id: 'patel-t1', scheduled_date: TOMORROW, confirmation_status: 'Confirmed', crew_available: true, start_time_confirmed: true, site_access_confirmed: true },
  ],
  materials: [
...
const nguyen: RepresentativeProject = {
  ...
  crewConfirmations: [
    { id: 'nguyen-c1', project_id: 'proj-nguyen', task_id: 'nguyen-t2', scheduled_date: TOMORROW, confirmation_status: 'Cannot Attend', crew_available: false, start_time_confirmed: false, site_access_confirmed: true },
  ],
  materials: [
