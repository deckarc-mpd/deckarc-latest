...
import {
  ...
  ChevronLeft, ChevronRight, Inbox, Microscope, Compass, ListChecks, Calculator,
} from 'lucide-react';
...
const adminNavItems = [
  ...
  { id: 'ai-estimate',   label: 'AI Estimate',          icon: Calculator },
...
const adminNavGroups: Record<string, string> = {
  ...
  projects: 'Operations', tasks: 'Operations', 'daily-updates': 'Operations', 'ai-estimate': 'Operations',
...
export default function Layout({ children, currentPage, onNavigate, clientProjectLabel }: LayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-slate-100 overflow-hidden">
      ...
      {/* Admin-only voice assistant (renders nothing for non-admins) */}
      <VoiceAssistant onNavigate={(page) => onNavigate(page as Page)} />
    </div>
  );
}
