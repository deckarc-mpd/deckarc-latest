...
import ComplianceAiTab from '../components/project/ComplianceAiTab';
import ClientCommsAiPanel from '../components/project/ClientCommsAiPanel';
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto bg-concrete-50 min-w-0">
          ...
          {tab === 'comms'                 && (
            <div className="p-6">
              {isAdmin && <ClientCommsAiPanel projectId={project.id} />}
...
function ProjectPermitsInspectionsTab({ project, role, onProjectUpdate }: { project: Project; role: string; onProjectUpdate?: () => void }) {
  ...
  const isAdminOrGc = !isClient && !isSub;
  type SubTab = 'permits' | 'checklist' | 'inspections' | 'ai-compliance';
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {sub === 'ai-compliance' && isAdminOrGc && <ComplianceAiTab projectId={project.id} />}
      </div>
    </div>
  );
}
